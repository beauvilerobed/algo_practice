...
# 1
# Your task in this problem is to run the clustering algorithm on 
# this data set, where the target number k of clusters is set to 4. What is the 
# maximum spacing of a 4-clustering?

# 2
# In this question your task is again to run the clustering algorithm, but on a MUCH bigger graph. So big, in fact, that the distances 
