...
# 1
# In this programming problem and the next you'll code up the greedy algorithm on 
# Huffman coding.

# Your task in this problem is to run the Huffman coding algorithm on this data set. 
